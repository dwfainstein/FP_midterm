...
library(purrr)
library(readr)
# David will try this section - open to help, or support when I get stuck!
...
oneyear <- download_file(15)

# files <- map_dfr(download_file(15), read_csv)
# pseudo-code:
#   a <- 15:18
#   map thru download_file for a instances
#   assign to object
#   staple together as one dataframe

OR_doefiles <- c(download_file(15), download_file(16), download_file(17), download_file(18))
#this gets me close, just need to do it in a map_dfr to staple together

combined <- map_dfr(OR_doefiles, read_csv)
#some issue with filenames.. I think I'll need to use list.files
